...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/publish', title: 'Publishing',  icon:'library_books', class: '' },
    { path: '/report', title: 'Report',  icon:'bubble_chart', class: '' },
    { path: '/community', title: 'Community',  icon:'library_books', class: '' },
